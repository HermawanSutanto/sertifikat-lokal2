...
export default function RegisterPage() {
  ...
  return (
    <main className="flex items-center justify-center min-h-screen bg-gradient-to-r from-indigo-100 to-indigo-200">
      <div className="w-full max-w-md p-10 space-y-8 bg-white rounded-3xl shadow-xl border border-indigo-300">
        ...
        <form onSubmit={handleRegister} className="space-y-6">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 border text-black border-indigo-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
            />
          </div>
          <div>
            <label className="block text-sm font-semibold text-indigo-700 mb-2">
          ...
          <button
            type="submit"
            className="w-full py-3 font-semibold text-white bg-indigo-600 rounded-lg shadow-md hover:bg-indigo-700 transition"
          >
            Register
          </button>
        </form>
